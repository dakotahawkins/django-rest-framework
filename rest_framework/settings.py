...
class APISettings(object):
    ...
    def __check_user_settings(self, user_settings):
        for setting in self._removed_settings:
            if setting in user_settings:
                raise RuntimeError("The '%s' setting has been removed. Please refer to '%s' for available settings." % (setting, self._settings_doc))
    ...
    def reload_api_settings(self, *args, **kwargs):
        setting = kwargs['setting']
        if setting == self._settings_key:
            self.reload()
